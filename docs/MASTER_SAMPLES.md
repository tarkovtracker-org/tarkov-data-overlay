...
`src/additions/storyChapters.json5` is generated by `npm run eft:story`, not hand-authored:
every chapter needs `chapterQuestId` and `referenceCoverage`, and every objective needs a real
reference objective `id` plus the `sourceQuestId` of its sub-quest, all of which come from the
pinned capture. Treat this as a field reference for consumers and for reviewing generator output.
The ids below are illustrative but well-formed, so the sample validates as-is.
...
```json5
{
  ...
  story_chapter_key_1: {
    ...
    order: 10, // Required
    chapterQuestId: '68cbd33676fe74b1e80bfd91', // Required | narrator-trader story quest id
    referenceCoverage: {
      // Required | how much of the chapter the pinned capture resolved
    ...
    objectives: [
      {
        id: '6512bd43d9caa6e02c990b0a', // Required | reference objective id
        sourceQuestId: '68cbd33676fe74b1e80bfd91', // Required | sub-quest this objective came from
      ...
      {
        id: 'c20ad4d76fe97759aa27a0c9', // Required | reference objective id
        sourceQuestId: '68cbcdc4c964ab83cc0c928e', // Required | sub-quest this objective came from
        type: 'main',
      ...
      {
        id: 'c51ce410c124a10e0db5e4b9', // Required | reference objective id
        sourceQuestId: '68da36cf7cff54fc6109874a', // Required | sub-quest this objective came from
        type: 'main',
      ...
      {
        id: 'aab3238922bcc25a6f606eb5', // Required | reference objective id
        sourceQuestId: '6900927ab7d28358f80b9421', // Required | sub-quest this objective came from
        type: 'optional',
